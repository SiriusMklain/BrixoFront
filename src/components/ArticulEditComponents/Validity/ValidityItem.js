...
function ValidityItem(props) {
    const {num, tc, maker, model, type} = props
    const [dropdownVisible, setDropdownVisible] = useState(false);
    const [criterionArray, setCriterionArray] = useState([]);
    const criterions = [
        { value: '1', label: 'Дата производста от' },
        { value: '2', label: 'Дата производста от 2' },
        { value: '3', label: 'Дата производста от 3' },
    ]


    function showDropdown() {
        setCriterionArray([...criterionArray,'new'])
    ...
    return (
            ...
            <tr>
                ...
                <td>
                    <div className="table__td">
                        <span>{type}</span>
                        <button
                            className="table__criterion"
                            onClick={()=>showDropdown()}
                        >
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.01602 0H7.98402C7.1092 0 6.40002 0.709181 6.40002 1.584V14.416C6.40002 15.2908 7.1092 16 7.98402 16H8.01602C8.89084 16 9.60002 15.2908 9.60002 14.416V1.584C9.60002 0.709181 8.89084 0 8.01602 0Z" fill="#6D71F9"/>
                                <path d="M14.416 6.3999H1.584C0.709181 6.3999 0 7.10908 0 7.9839V8.0159C0 8.89072 0.709181 9.5999 1.584 9.5999H14.416C15.2908 9.5999 16 8.89072 16 8.0159V7.9839C16 7.10908 15.2908 6.3999 14.416 6.3999Z" fill="#6D71F9"/>
                            </svg>
        ...
        {dropdownVisible ?
            <tr>
                <td colSpan="5">
                    <div className="criterions data-block__grid">
                        {criterionArray.map((criterion,index) =>
                            <div
                                className="criterions__group"
                                key={index}
                            >
