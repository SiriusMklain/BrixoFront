...
class Item extends Component {
    ...
    deleteCriteria() {
        apiService.deleteCriteria(this.props.art_no_id, this.props.section.crit_id).then(() => {
            this.close()
            ...
            <>
                <tr>
                    ...
                    <td style={{borderTop: 0}}>
                        <div className="table__nav" style={{right: 60}}>
                            <button
                                onClick={this.open}
                ...
                <Modal show={this.state.showModal} onHide={this.close}>
                    ...
                    <Modal.Body>Вы уверены, что хотите удалить критерий <b>{this.props.section.sort_no}</b> ?</Modal.Body>
                    <Modal.Footer>
                        <Button variant="secondary" onClick={this.close}>
                            Закрыть
                        </Button>
                        <Button variant="danger" onClick={this.deleteCriteria}>
                            Удалить
                        </Button>
                    </Modal.Footer>
                </Modal>
